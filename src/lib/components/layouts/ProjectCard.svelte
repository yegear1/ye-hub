<script lang="ts">
    ...
    const statusConfig = {
        ...
        degraded: { color: "bg-yellow-500", text: "Degraded", bg: "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 border-yellow-200 dark:border-yellow-900/50" },
...
<div class="group relative flex flex-col bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-lg p-5 hover:shadow-sm hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200">
    ...
    <h3 class="text-base font-semibold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 transition-colors">
        {project.name}
    </h3>
